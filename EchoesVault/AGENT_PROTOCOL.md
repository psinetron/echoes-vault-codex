...
1. Invoke `.echoes-vault/echoes_vault.py` for every mutation, passing `--workspace .`,
...
and raw sources. Do not commit `EchoesVault/index.md`, `.echoes-vault/state.json`,
`.echoes-vault/lock`, `.opencode/echoes-state.json`, or
